...
- **PFI**: Will show inflated importance for x1 due to confounding (the confounder H contributes to x1's predictive power beyond its direct effect)
- **CFI**: Should partially account for confounding through conditional sampling
- **RFI conditioning on proxy**: Should reduce confounding bias by conditioning on the noisy measurement of the confounder
