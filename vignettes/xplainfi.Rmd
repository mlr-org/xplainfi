...
- **Backend choice**: Use either `future::plan()` or `mirai::daemons()` - both work with the same code
- **Consistency**: Both PerturbationImportance (PFI/CFI/RFI) and WVIM (LOCO) use the same mlr3 parallelization infrastructure
