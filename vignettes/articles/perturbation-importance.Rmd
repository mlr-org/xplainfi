...
x1 and x2 have **no direct effects** - they affect y only through their interaction (thick red arrow). 
However, PFI will still show them as important because permuting either feature destroys the crucial interaction term.
...
In the pure interaction case (y = 2·x1·x2 + x3), when we condition on one interacting feature, the other becomes extremely important because they only matter together. This demonstrates RFI's power to answer targeted questions like "Given I already know x2, how much does x1 add?"
