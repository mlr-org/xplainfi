...
The `"quantile"` method returns only confidence bounds (`conf_lower`, `conf_upper`) without `se`, `statistic`, or `p.value`, as empirical quantiles and hypothesis testing require different methodologies.
