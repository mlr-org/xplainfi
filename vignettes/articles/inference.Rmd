...
The key idea is to test whether the excess test error from removing feature $j$ is significantly greater than zero:
...
- A **test set** where each observation appears at most once (e.g., holdout or cross-validation)
