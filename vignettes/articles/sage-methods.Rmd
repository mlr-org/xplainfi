...
Standard errors and early stopping for the kernel estimator are not available yet, so check `$plot_convergence()` and increase `n_coalitions` until the values settle.
